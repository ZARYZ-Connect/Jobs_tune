...
from base.models import JOBS_TUNEMailTemplate, JobPosition
...
from JOBS_TUNE.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = JOBS_TUNEMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        JOBS_TUNEMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
