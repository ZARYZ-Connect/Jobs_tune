...
class AttendanceActivity(JOBS_TUNEModel):
    """
...
class BatchAttendance(JOBS_TUNEModel):
    """
...
class Attendance(JOBS_TUNEModel):
    """
    Attendance model
    """
...
class AttendanceRequestFile(JOBS_TUNEModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(JOBS_TUNEModel):
    """
...
class AttendanceOverTime(JOBS_TUNEModel):
    """
...
class AttendanceLateComeEarlyOut(JOBS_TUNEModel):
    """
...
class AttendanceValidationCondition(JOBS_TUNEModel):
    """
...
class GraceTime(JOBS_TUNEModel):
    """
...
class AttendanceGeneralSetting(JOBS_TUNEModel):
    """
