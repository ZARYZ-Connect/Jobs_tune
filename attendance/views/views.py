...
from JOBS_TUNE.JOBS_TUNE_settings import DYNAMIC_URL_PATTERNS, JOBS_TUNE_DATE_FORMATS
from JOBS_TUNE.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = JOBS_TUNE_DATE_FORMATS.get(date_format)
