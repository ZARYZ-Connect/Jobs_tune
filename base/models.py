...
from JOBS_TUNE import JOBS_TUNE_middlewares
from JOBS_TUNE.JOBS_TUNE_middlewares import _thread_locals
from JOBS_TUNE.models import JOBS_TUNEModel, upload_path
...
class Department(JOBS_TUNEModel):
    """
    Department model
    """
    ...
    objects = JOBS_TUNECompanyManager()
...
class JobPosition(JOBS_TUNEModel):
    """
    JobPosition model
    """
    ...
    objects = JOBS_TUNECompanyManager("department_id__company_id")
...
class JobRole(JOBS_TUNEModel):
    ...
    objects = JOBS_TUNECompanyManager("job_position_id__department_id__company_id")
...
class RotatingWorkType(JOBS_TUNEModel):
    """
    ...
    objects = JOBS_TUNECompanyManager("employee_id__employee_work_info__company_id")
...
class RotatingWorkTypeAssign(JOBS_TUNEModel):
    """
...
class EmployeeType(JOBS_TUNEModel):
    """
    EmployeeType model
    """
...
class EmployeeShift(JOBS_TUNEModel):
    """
    EmployeeShift model
    """
    ...
    objects = JOBS_TUNECompanyManager("employee_shift__company_id")
...
class EmployeeShiftSchedule(JOBS_TUNEModel):
    """
    ...
    auto_punch_out_time = models.TimeField(
        ...
        help_text=_(
            "Time at which the JOBS_TUNE will automatically check out the employee attendance if they forget."
        ),
    )
    company_id = models.ManyToManyField(Company, blank=True, verbose_name=_("Company"))

    objects = JOBS_TUNECompanyManager("shift_id__employee_shift__company_id")
...
class RotatingShift(JOBS_TUNEModel):
    """
    RotatingShift model
    """
...
class RotatingShiftAssign(JOBS_TUNEModel):
    """
...
class WorkTypeRequest(JOBS_TUNEModel):
    """
    ...
    def clean(self):
        request = getattr(JOBS_TUNE_middlewares._thread_locals, "request", None)
...
class WorkTypeRequestComment(JOBS_TUNEModel):
    """
...
class ShiftRequest(JOBS_TUNEModel):
    """
    ShiftRequest model
    """
...
class ShiftRequestComment(JOBS_TUNEModel):
    """
...
class Tags(JOBS_TUNEModel):
    title = models.CharField(max_length=30)
    color = models.CharField(max_length=30)
    company_id = models.ForeignKey(
        Company, null=True, editable=False, on_delete=models.PROTECT
    )
    objects = JOBS_TUNECompanyManager(related_company_field="company_id")
...
class JOBS_TUNEMailTemplate(JOBS_TUNEModel):
...
class DynamicEmailConfiguration(JOBS_TUNEModel):
    """
...
class MultipleApprovalCondition(JOBS_TUNEModel):
...
class Announcement(JOBS_TUNEModel):
    """
...
class AnnouncementComment(JOBS_TUNEModel):
    """
...
class DashboardEmployeeCharts(JOBS_TUNEModel):
    from employee.models import Employee
...
class TrackLateComeEarlyOut(JOBS_TUNEModel):
...
class CompanyLeaves(JOBS_TUNEModel):
...
class PenaltyAccounts(JOBS_TUNEModel):
    """
