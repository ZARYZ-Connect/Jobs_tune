...
from JOBS_TUNE.decorators import hx_request_required, login_required, permission_required
...
def white_labelling_company(request):
    ...
    if white_labelling:
        ...
        return {
            "white_label_company_name": company.company if company else "JOBS_TUNE",
            "white_label_company": company,
        }
    else:
        return {
            "white_label_company_name": "JOBS_TUNE",
...
def resignation_request_enabled(request):
    ...
    if apps.is_installed("offboarding"):
        OffboardingGeneralSetting = get_JOBS_TUNE_model_class(
...
def timerunner_enabled(request):
    ...
    if apps.is_installed("attendance"):
        AttendanceGeneralSetting = get_JOBS_TUNE_model_class(
...
def intial_notice_period(request):
    ...
    if apps.is_installed("payroll"):
        PayrollGeneralSetting = get_JOBS_TUNE_model_class(
...
def check_candidate_self_tracking(request):
    ...
    if apps.is_installed("recruitment"):
        RecruitmentGeneralSetting = get_JOBS_TUNE_model_class(
