...
from JOBS_TUNE.JOBS_TUNE_apps import TWO_FACTORS_AUTHENTICATION
from JOBS_TUNE.JOBS_TUNE_settings import APPS
from JOBS_TUNE.methods import get_JOBS_TUNE_model_class
from JOBS_TUNE_documents.models import DocumentRequest

CACHE_KEY = "JOBS_TUNE_company_models_cache_key"
...
class CompanyMiddleware:
    ...
    def _add_company_filter(self, model, company_id):
        ...
        is_JOBS_TUNE_manager = isinstance(model.objects, JOBS_TUNECompanyManager)
        ...
        if is_company_model:
            ...
            elif is_JOBS_TUNE_manager and related_company_field:
                model.add_to_class(
            ...
            for app_label, models in app_model_mappings.items():
                if apps.is_installed(app_label):
                    company_models.extend(
                        [get_JOBS_TUNE_model_class(app_label, model) for model in models]
                    )
