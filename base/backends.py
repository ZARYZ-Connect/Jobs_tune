...
class DefaultJOBS_TUNEMailBackend(EmailBackend):
    def __init__(
        self,
        host=None,
        port=None,
...
BACKEND_CLASS: EmailBackend = DefaultJOBS_TUNEMailBackend
default = "base.backends.ConfiguredEmailBackend"

setattr(BACKEND_CLASS, "send_messages", DefaultJOBS_TUNEMailBackend.send_messages)
