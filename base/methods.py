...
from JOBS_TUNE.JOBS_TUNE_apps import NESTED_SUBORDINATE_VISIBILITY
from JOBS_TUNE.JOBS_TUNE_middlewares import _thread_locals
from JOBS_TUNE.JOBS_TUNE_settings import JOBS_TUNE_DATE_FORMATS, JOBS_TUNE_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in JOBS_TUNE_TIME_FORMATS.items():
