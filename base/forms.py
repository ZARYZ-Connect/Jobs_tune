...
from JOBS_TUNE_audit.models import AuditTag
...
class AssignPermission(Form):
    ...
    employee = JOBS_TUNEMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = JOBS_TUNEMultiSelectField(
...
class RotatingWorkTypeAssignForm(ModelForm):
    ...
    employee_id = JOBS_TUNEMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = JOBS_TUNEMultiSelectField(
        queryset=Employee.objects.all(),
        widget=JOBS_TUNEMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], JOBS_TUNEMultiSelectField):
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_JOBS_TUNE_model_class(app_label="leave", model="leavetype")
