...
from JOBS_TUNE.methods import dynamic_attr, get_JOBS_TUNE_model_class, get_urlencode
    ...
    for column_value, column_name in selected_columns:
        ...
        for payslip in payslips:
            ...
            if type(value) == date:
                ...
                for format_name, format_string in JOBS_TUNE_DATE_FORMATS.items():
...
def asset_fine(request):
    ...
    if apps.is_installed("asset"):
        Asset = get_JOBS_TUNE_model_class(app_label="asset", model="asset")
