...
class FilingStatus(JOBS_TUNEModel):
    """
    FilingStatus model
    """
...
class Allowance(JOBS_TUNEModel):
    """
    Allowance model
    """
...
class Deduction(JOBS_TUNEModel):
    """
    Deduction model
    """
...
class LoanAccount(JOBS_TUNEModel):
    """
...
class Reimbursement(JOBS_TUNEModel):
    """
    Reimbursement Model
    """
            ...
            if self.status == "approved" and self.allowance_id is None:
                if self.type == "reimbursement":
                    ...
                    if bonus_points.points >= self.bonus_to_encash:
                        ...
                        request = getattr(
                            JOBS_TUNE_middlewares._thread_locals, "request", None
                        )
                        if request:
                            messages.info(
                                request,
...
class ReimbursementrequestComment(JOBS_TUNEModel):
    """
