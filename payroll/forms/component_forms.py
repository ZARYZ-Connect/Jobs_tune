...
from JOBS_TUNE_widgets.forms import JOBS_TUNEForm, default_select_option_template
...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = JOBS_TUNEMultiSelectField(
...
class GeneratePayslipForm(JOBS_TUNEForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(JOBS_TUNE_middlewares._thread_locals, "request", None)
    ...
    def setup_leave_fields(self):
        ...
        AvailableLeave = get_JOBS_TUNE_model_class(
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_JOBS_TUNE_model_class("leave", "availableleave")
