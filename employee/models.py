...
from JOBS_TUNE.models import JOBS_TUNEModel, has_xss, upload_path
from JOBS_TUNE_audit.methods import get_diff
...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_JOBS_TUNE_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_JOBS_TUNE_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_JOBS_TUNE_model_class("recruitment", "recruitment")
            Stage = get_JOBS_TUNE_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_JOBS_TUNE_model_class("attendance", "attendance")
...
class EmployeeTag(JOBS_TUNEModel):
    """
    EmployeeTag Model
    """
...
class EmployeeBankDetails(JOBS_TUNEModel):
    """
...
class NoteFiles(JOBS_TUNEModel):
...
class EmployeeNote(JOBS_TUNEModel):
    """
    EmployeeNote model
    """
...
class PolicyMultipleFile(JOBS_TUNEModel):
    """
...
class Policy(JOBS_TUNEModel):
    ...
    objects = JOBS_TUNECompanyManager("company_id")
...
class BonusPoint(JOBS_TUNEModel):
    """
...
class Actiontype(JOBS_TUNEModel):
    """
    Action type model
    """
...
class DisciplinaryAction(JOBS_TUNEModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(JOBS_TUNEModel):
    """
...
class ProfileEditFeature(JOBS_TUNEModel):
    """
    ProfileEditFeature
    """
