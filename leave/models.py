...
class LeaveType(JOBS_TUNEModel):
...
class CompanyLeave(JOBS_TUNEModel):
...
class AvailableLeave(JOBS_TUNEModel):
...
class LeaveRequest(JOBS_TUNEModel):
    employee_id = models.ForeignKey(
...
class LeaverequestComment(JOBS_TUNEModel):
    """
...
class LeaveAllocationRequest(JOBS_TUNEModel):
    leave_type_id = models.ForeignKey(
        LeaveType, on_delete=models.PROTECT, verbose_name=_("Leave type")
    )
    employee_id = models.ForeignKey(
...
class LeaveallocationrequestComment(JOBS_TUNEModel):
    """
...
class RestrictLeave(JOBS_TUNEModel):
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(JOBS_TUNEModel):
        leave_type_id = models.ForeignKey(
...
class LeaveGeneralSetting(JOBS_TUNEModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(JOBS_TUNEModel):
        """
...
class EmployeePastLeaveRestrict(JOBS_TUNEModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        #     """
        #     WorkRecords = get_JOBS_TUNE_model_class(
