"""
This module provides JOBS_TUNE ModelForms for creating and managing leave-related data,
...
from JOBS_TUNE_widgets.forms import JOBS_TUNEForm, JOBS_TUNEModelForm
...
class LeaveOneAssignForm(JOBS_TUNEModelForm):
    """
    ...
    Attributes:
        - employee_id: A JOBS_TUNEMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(JOBS_TUNEForm):
    """
    Form for Payslip
    """
