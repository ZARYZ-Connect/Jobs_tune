...
class Offboarding(JOBS_TUNEModel):
    """
    Offboarding model
    """
...
class OffboardingStage(JOBS_TUNEModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(JOBS_TUNEModel):
    """
...
class OffboardingEmployee(JOBS_TUNEModel):
    """
...
class ResignationLetter(JOBS_TUNEModel):
    """
...
class OffboardingTask(JOBS_TUNEModel):
    """
...
class EmployeeTask(JOBS_TUNEModel):
    """
    EmployeeTask model
    """
...
class ExitReason(JOBS_TUNEModel):
    """
    ExitReason model
    """
...
class OffboardingNote(JOBS_TUNEModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(JOBS_TUNEModel):
    """
