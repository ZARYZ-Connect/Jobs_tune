...
This module is used to write JOBS_TUNE form select widgets
"""
...
class JOBS_TUNEMultiSelectWidget(forms.Widget):
    """
    JOBS_TUNEMultiSelectWidget
    """
    ...
    template_name = "JOBS_TUNE_widgets/JOBS_TUNE_multiselect_widget.html"
