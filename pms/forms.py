...
from base.forms import ModelForm as JOBS_TUNEModelForm
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = JOBS_TUNEMultiSelectField(
        ...
        self.fields["managers"] = JOBS_TUNEMultiSelectField(
            queryset=Employee.objects.all(),
            widget=JOBS_TUNEMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class KRForm(JOBS_TUNEModelForm):
    """
...
class FeedbackForm(JOBS_TUNEModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # JOBS_TUNE multi-select filter for subordinates
        # self.fields["subordinate_id"] = JOBS_TUNEMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=JOBS_TUNEMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class MeetingsForm(BaseForm):
    ...
    def as_p(self):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("JOBS_TUNE_form.html", context)
        return table_html
...
class BonusPointSettingForm(JOBS_TUNEModelForm):
    """
...
class EmployeeBonusPointForm(JOBS_TUNEModelForm):
    """
...
class EmployeeFeedbackForm(JOBS_TUNEModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = JOBS_TUNEMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=JOBS_TUNEMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], JOBS_TUNEMultiSelectField):
...
class BulkFeedbackForm(JOBS_TUNEModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = JOBS_TUNEMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=JOBS_TUNEMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], JOBS_TUNEMultiSelectField):
