...
class KeyResult(JOBS_TUNEModel):
    ...
    history = JOBS_TUNEAuditLog(bases=[JOBS_TUNEAuditInfo])
...
class Objective(JOBS_TUNEModel):
...
class EmployeeObjective(JOBS_TUNEModel):
    ...
    history = JOBS_TUNEAuditLog(bases=[JOBS_TUNEAuditInfo], related_name="history_set")
    archive = models.BooleanField(default=False)
...
class Comment(models.Model):
    ...
    history = JOBS_TUNEAuditLog(excluded_fields=["comment"], bases=[JOBS_TUNEAuditInfo])
    objects = JOBS_TUNECompanyManager(
...
class QuestionTemplate(JOBS_TUNEModel):
...
class Question(JOBS_TUNEModel):
    ...
    objects = JOBS_TUNECompanyManager("template_id__company_id")

    def __str__(self):
        return self.question


class QuestionOptions(JOBS_TUNEModel):
    ...
    objects = JOBS_TUNECompanyManager("question_id__template_id__company_id")


class Feedback(JOBS_TUNEModel):
...
class EmployeeBonusPoint(JOBS_TUNEModel):
    employee_id = models.ForeignKey(
        Employee,
        on_delete=models.DO_NOTHING,
