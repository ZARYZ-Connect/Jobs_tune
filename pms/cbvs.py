...
from JOBS_TUNE.decorators import login_required, owner_can_enter, permission_required
...
class BonusPointSettingSectionView(views.JOBS_TUNESectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.JOBS_TUNENavView):
    """
...
class BonusPointSettingFormView(views.JOBS_TUNEFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.JOBS_TUNEListView):
    """
...
class EmployeeBonusPointSectionView(views.JOBS_TUNESectionView):
    """
...
class EmployeeBonusPointNavView(views.JOBS_TUNENavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.JOBS_TUNEFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.JOBS_TUNEListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.JOBS_TUNEFormView):
    """
...
class BulkFeedbackFormView(views.JOBS_TUNEFormView):
    """
    Feedback other employee form View
    """
