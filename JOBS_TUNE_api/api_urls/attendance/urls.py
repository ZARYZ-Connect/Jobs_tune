"""
JOBS_TUNE_api/urls/attendance/urls.py
"""

from django.urls import path

from JOBS_TUNE_api.api_views.attendance.permission_views import AttendancePermissionCheck
from JOBS_TUNE_api.api_views.attendance.views import *
