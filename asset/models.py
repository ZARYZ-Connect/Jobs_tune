...
class AssetCategory(JOBS_TUNEModel):
    """
...
class Asset(JOBS_TUNEModel):
    ...
    objects = JOBS_TUNECompanyManager("asset_category_id__company_id")
...
class AssetReport(JOBS_TUNEModel):
    """
...
class AssetDocuments(JOBS_TUNEModel):
    """
...
class ReturnImages(JOBS_TUNEModel):
    """
...
class AssetAssignment(JOBS_TUNEModel):
    """
    ...
    objects = JOBS_TUNECompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(JOBS_TUNEModel):
    """
