...
class DepartmentManager(JOBS_TUNEModel):
    ...
    objects = JOBS_TUNECompanyManager("manager__employee_work_info__company_id")
...
class TicketType(JOBS_TUNEModel):
...
class ClaimRequest(JOBS_TUNEModel):
...
class Attachment(JOBS_TUNEModel):
...
class FAQCategory(JOBS_TUNEModel):
