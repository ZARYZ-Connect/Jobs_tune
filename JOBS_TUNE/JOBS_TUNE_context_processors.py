"""
JOBS_TUNE_context_process.py

This module is used to register context processors without effecting the JOBS_TUNE/settings.py module
"""

from JOBS_TUNE.settings import TEMPLATES

TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "JOBS_TUNE.config.get_MENUS",
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
