"""
Django settings for JOBS_TUNE project.
...
WSGI_APPLICATION = "JOBS_TUNE.wsgi.application"
...
LOCALE_PATHS = [
    join(BASE_DIR, "JOBS_TUNE", "locale"),
]
