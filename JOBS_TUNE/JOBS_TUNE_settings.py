...
from JOBS_TUNE.JOBS_TUNE_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=JOBS_TUNE,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="JOBS_TUNE"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=JOBS_TUNE,dc=com"),
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from JOBS_TUNE_ldap.models import LDAPSettings
