...
from JOBS_TUNE.JOBS_TUNE_settings import APP_URLS, DYNAMIC_URL_PATTERNS


def get_JOBS_TUNE_model_class(app_label, model):
    """
...
def JOBS_TUNE_users_with_perms(permissions):
    """
