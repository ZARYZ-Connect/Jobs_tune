...
This module defines the abstract base model `JOBS_TUNEModel` for the JOBS_TUNE HRMS project.
The `JOBS_TUNEModel` provides common fields and functionalities for other models within
...
class JOBS_TUNEModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the JOBS_TUNE application.
    """
    ...
    JOBS_TUNE_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for JOBS_TUNEModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(JOBS_TUNEModel, self).save(*args, **kwargs)
...
auditlog.register(JOBS_TUNEModel, serialize_data=True)
