"""
JOBS_TUNE_automations/views/cbvs.py
"""
...
from base.models import JOBS_TUNEMailTemplate
from JOBS_TUNE.decorators import login_required, permission_required
from JOBS_TUNE_automations import models
from JOBS_TUNE_automations.filters import AutomationFilter
from JOBS_TUNE_automations.forms import AutomationForm
from JOBS_TUNE_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("JOBS_TUNE_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.JOBS_TUNESectionView):
    """
    ...
    template_name = "JOBS_TUNE_automations/section_view.html"
...
class AutomationNavView(views.JOBS_TUNENavView):
    """
    AutomationNavView
    """
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("JOBS_TUNE_automations.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("JOBS_TUNE_automations.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.JOBS_TUNEFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "JOBS_TUNE_automations/automation_form.html"
...
class AutomationListView(views.JOBS_TUNEListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.JOBS_TUNEDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("JOBS_TUNE_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "JOBS_TUNE_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = JOBS_TUNEMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = JOBS_TUNEMailTemplate.objects.filter(
                body=template_body
            ).first()
