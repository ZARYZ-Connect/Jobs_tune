"""
JOBS_TUNE_automation/views/views.py
"""
...
from JOBS_TUNE_automations.methods.methods import generate_choices
from JOBS_TUNE_automations.methods.serialize import serialize_form
from JOBS_TUNE_automations.models import MailAutomation
from JOBS_TUNE_automations.signals import REFRESH_METHODS
...
@login_required
@permission_required("JOBS_TUNE_automations.delete_mailautomation")
...
@login_required
@permission_required("JOBS_TUNE_automations.add_mailautomation")
