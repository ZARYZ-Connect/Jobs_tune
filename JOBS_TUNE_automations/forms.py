"""
JOBS_TUNE_automations/forms.py
"""
...
from JOBS_TUNE_automations.models import MODEL_CHOICES, MailAutomation
from JOBS_TUNE_widgets.forms import default_select_option_template
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # --- Field: also_sent_to ---
        self.fields["also_sent_to"] = JOBS_TUNEMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], JOBS_TUNEMultiSelectField):
