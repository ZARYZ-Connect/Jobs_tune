"""
JOBS_TUNE_automation/signals.py
...
from JOBS_TUNE.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from JOBS_TUNE_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=JOBS_TUNEMailTemplate)
    @receiver(post_save, sender=JOBS_TUNEMailTemplate)
...
def send_automated_mail(
    ...
    from JOBS_TUNE_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from JOBS_TUNE_automations.methods.methods import (
        get_model_class,
