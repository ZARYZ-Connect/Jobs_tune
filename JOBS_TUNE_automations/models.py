...
class MailAutomation(JOBS_TUNEModel):
    """
    MailAutoMation
    """
    ...
    mail_template = models.ForeignKey(
        JOBS_TUNEMailTemplate, on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    def get_mail_to_display(self):
        ...
        return render_template(
            "JOBS_TUNE_automations/mail_to.html", {"instance": self, "mappings": mappings}
        )

    def get_mail_cc_display(self):
        employees = self.also_sent_to.all()
        return render_template(
            "JOBS_TUNE_automations/mail_cc.html", {"employees": employees}
        )
    ...
    def conditions(self):
        return render_template(
            "JOBS_TUNE_automations/conditions.html", {"instance": self}
        )
