"""
JOBS_TUNE_views/urls.py
"""

from django.urls import path

from JOBS_TUNE_views import views
from JOBS_TUNE_views.generic.cbv import history
from JOBS_TUNE_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.JOBS_TUNEDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "JOBS_TUNE-history-revert/<int:pk>/<int:history_id>/",
        history.JOBS_TUNEHistoryView.as_view(),
        name="history-revert",
    ),
]
