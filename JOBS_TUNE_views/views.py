...
from JOBS_TUNE.signals import post_generic_delete, pre_generic_delete
from JOBS_TUNE_views import models
from JOBS_TUNE_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from JOBS_TUNE_views.forms import SavedFilterForm
from JOBS_TUNE_views.generic.cbv.views import JOBS_TUNEFormView, JOBS_TUNEListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.JOBS_TUNEModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(JOBS_TUNEFormView):
    """
    SavedFilter
    """
...
class DynamiListView(JOBS_TUNEListView):
    """
...
class JOBS_TUNEDeleteConfirmationView(View):
    """
