...
from JOBS_TUNE.filters import FilterSet
from JOBS_TUNE.group_by import group_by_queryset
from JOBS_TUNE.JOBS_TUNE_middlewares import _thread_locals
from JOBS_TUNE.signals import post_generic_import, pre_generic_import
from JOBS_TUNE_views import models
from JOBS_TUNE_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from JOBS_TUNE_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from JOBS_TUNE_views.templatetags.generic_template_filters import getattribute

logger = logging.getLogger(__name__)


@method_decorator(hx_request_required, name="dispatch")
class JOBS_TUNEListView(ListView):
    """
    JOBS_TUNEListView
    """
    ...
    template_name: str = "generic/JOBS_TUNE_list_table.html"
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[JOBS_TUNEListView] = context
        from JOBS_TUNE.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class JOBS_TUNEListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = JOBS_TUNEListViewResorce()
...
class JOBS_TUNESectionView(TemplateView):
    """
    JOBS_TUNE Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, JOBS_TUNEListView)
    ...
    template_name = "generic/JOBS_TUNE_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class JOBS_TUNEDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/JOBS_TUNE_detailed_view.html"
    header: dict = {
        "title": "JOBS_TUNE",
        "subtitle": "JOBS_TUNE Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, JOBS_TUNEDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class JOBS_TUNETabView(TemplateView):
    """
    JOBS_TUNETabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/JOBS_TUNE_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, JOBS_TUNETabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[JOBS_TUNETabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class JOBS_TUNECardView(ListView):
    """
    JOBS_TUNECardView
    """
    ...
    template_name = "generic/JOBS_TUNE_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, JOBS_TUNECardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[JOBS_TUNECardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class JOBS_TUNEFormView(FormView):
    """
    JOBS_TUNEFormView
    """
    ...
    template_name = "generic/JOBS_TUNE_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, JOBS_TUNEFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "JOBS_TUNE_widgets/select_option.html",
                    )
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[JOBS_TUNEFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class JOBS_TUNENavView(TemplateView):
    """
    JOBS_TUNENavView
    ...
    template_name = "generic/JOBS_TUNE_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, JOBS_TUNENavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[JOBS_TUNENavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class JOBS_TUNEProfileView(DetailView):
    """
    GenericJOBS_TUNEProfileView
    """

    template_name = "generic/JOBS_TUNE_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, JOBS_TUNEProfileView)
