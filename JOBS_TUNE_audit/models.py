...
from JOBS_TUNE_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "JOBS_TUNE_audit"


class JOBS_TUNEAuditInfo(models.Model):
    """
    JOBS_TUNEAuditInfo model to store additional info
    """
...
class JOBS_TUNEAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(JOBS_TUNEAuditLog, self).__init__(*args, **kwargs)
    #     self.is_JOBS_TUNE_audit_log = True
...
def pre_create_JOBS_TUNE_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_JOBS_TUNE_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, JOBS_TUNEAuditLog):
