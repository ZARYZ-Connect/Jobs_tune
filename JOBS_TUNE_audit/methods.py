...
from JOBS_TUNE.decorators import apply_decorators
...
class Bot:
    ...
    def __str__(self) -> str:
        return "JOBS_TUNE Bot"

    def get_avatar(self):
        return "https://ui-avatars.com/api/?name=JOBS_TUNE+Bot&background=random"
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.JOBS_TUNE_history.all()
        ...
        return render(
            request,
            "JOBS_TUNE_audit/history_tracking.html",
            context,
        )
