...
from JOBS_TUNE_views.cbv_methods import login_required, permission_required
...
class ProjectsNavView(JOBS_TUNENavView):
    """
    Nav bar
    """
...
class ProjectsList(JOBS_TUNEListView):
    """
    Projects list view
    """
...
class ProjectFormView(JOBS_TUNEFormView):
    """
...
class ProjectCardView(JOBS_TUNECardView):
    """
    For card view
    """
...
# Remove the command lines after JOBS_TUNE converted into CBV
