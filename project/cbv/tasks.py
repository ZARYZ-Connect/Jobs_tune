...
@method_decorator(login_required, name="dispatch")
class TaskListView(JOBS_TUNEListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TasksNavBar(JOBS_TUNENavView):
    """
    navbar of teh page
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(JOBS_TUNEFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(JOBS_TUNEDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(JOBS_TUNECardView):
    """
