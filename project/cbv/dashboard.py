...
from JOBS_TUNE_views.generic.cbv.views import JOBS_TUNEDetailedView, JOBS_TUNEListView
...
class ProjectsDueInMonth(JOBS_TUNEListView):
...
class ProjectDetailView(JOBS_TUNEDetailedView):
    """
