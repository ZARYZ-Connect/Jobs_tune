...
from JOBS_TUNE_views.cbv_methods import login_required
from JOBS_TUNE_views.generic.cbv.views import (
    JOBS_TUNECardView,
    JOBS_TUNEDetailedView,
    JOBS_TUNEFormView,
    JOBS_TUNEListView,
    JOBS_TUNENavView,
    TemplateView,
...
class TimeSheetNavView(JOBS_TUNENavView):
    """
    Nav bar
    """
...
class TimeSheetList(JOBS_TUNEListView):
    """
...
class TaskTimeSheet(TimeSheetList):
    ...
    def get_queryset(self):
        queryset = JOBS_TUNEListView.get_queryset(self)
        task_id = self.kwargs.get("task_id")
...
class TimeSheetFormView(JOBS_TUNEFormView):
    """
...
class TimeSheetCardView(JOBS_TUNECardView):
    """
    For card view
    """
...
class TimeSheetDetailView(JOBS_TUNEDetailedView):
    """
