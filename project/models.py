...
class ProjectStage(JOBS_TUNEModel):
    """
    ProjectStage model
    """
    ...
    objects = JOBS_TUNECompanyManager("project__company_id")
...
class TimeSheet(JOBS_TUNEModel):
    """
    TimeSheet model
    """
    ...
    objects = JOBS_TUNECompanyManager("project_id__company_id")
