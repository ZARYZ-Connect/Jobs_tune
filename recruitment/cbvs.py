...
class LinkedinSettingSectionView(views.JOBS_TUNESectionView):
    """
...
class LinkedInSettingNavView(views.JOBS_TUNENavView):
    """
...
class LinkedInAccountFormView(views.JOBS_TUNEFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.JOBS_TUNEListView):
    """
