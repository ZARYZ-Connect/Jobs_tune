...
from base.models import EmailLog, JOBS_TUNEMailTemplate, JobPosition, clear_messages
...
from JOBS_TUNE_documents.models import Document
...
def send_acknowledgement(request):
    ...
    for candidate in candidates:
        ...
        bodys = list(
            JOBS_TUNEMailTemplate.objects.filter(
