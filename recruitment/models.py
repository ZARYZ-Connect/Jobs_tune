...
from JOBS_TUNE_views.cbv_methods import render_template
...
class SurveyTemplate(JOBS_TUNEModel):
    """
...
class Recruitment(JOBS_TUNEModel):
    """
    Recruitment model
    """
...
class Stage(JOBS_TUNEModel):
    ...
    objects = JOBS_TUNECompanyManager(related_company_field="recruitment_id__company_id")
...
class Candidate(JOBS_TUNEModel):
    """
    Candidate model
    """
...
class RejectReason(JOBS_TUNEModel):
    """
    RejectReason
    """
...
class RejectedCandidate(JOBS_TUNEModel):
    """
    RejectedCandidate
    """
...
class StageFiles(JOBS_TUNEModel):
...
class StageNote(JOBS_TUNEModel):
    """
    StageNote model
    """
...
class RecruitmentSurvey(JOBS_TUNEModel):
    """
    ...
    objects = JOBS_TUNECompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(JOBS_TUNEModel):
    """
...
class RecruitmentSurveyAnswer(JOBS_TUNEModel):
    """
...
class SkillZone(JOBS_TUNEModel):
    """ "
...
class SkillZoneCandidate(JOBS_TUNEModel):
    """
...
class CandidateRating(JOBS_TUNEModel):
...
class RecruitmentGeneralSetting(JOBS_TUNEModel):
    """
...
class InterviewSchedule(JOBS_TUNEModel):
    """
...
class CandidateDocumentRequest(JOBS_TUNEModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(JOBS_TUNEModel):
...
class LinkedInAccount(JOBS_TUNEModel):
